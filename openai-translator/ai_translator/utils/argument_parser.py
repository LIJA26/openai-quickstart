...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', default='GLMModel' , type=str, required=True, choices=['GLMModel', 'OpenAIModel'], help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')
        ...
        self.parser.add_argument('--openai_base_url', type=str, help='The Base url.')
